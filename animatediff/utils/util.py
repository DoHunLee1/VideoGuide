...
from animatediff.utils.convert_lora_safetensor_to_diffusers import convert_lora, load_diffusers_lora, load_diffusers_lora_unet
...
def init_prompt(prompt, pipeline):
    ...
    context = torch.cat([uncond_embeddings, text_embeddings]).to(dtype=torch.float16)
...
def load_motion_module_weights(
    ...
    if adapter_lora_path != "":
        ...
        unet = load_diffusers_lora_unet(unet, domain_lora_state_dict, alpha=adapter_lora_scale)
