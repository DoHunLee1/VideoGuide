...
class VanillaTemporalModule(nn.Module):
    ...
    def forward(self, input_tensor, temb, encoder_hidden_states, attention_mask=None):
...
class TemporalTransformerBlock(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None, video_length=None):
        ...
        if not self.local_window:
            ...
            views = get_views(video_length, stride=8)
            ...
            for t_start, t_end in views:
                ...
                weight_tensor = weight_tensor.to(hidden_states.device)
